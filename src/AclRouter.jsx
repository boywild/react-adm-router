...
const 1 = {
    authorities: PropTypes.oneOfType([PropTypes.string, PropTypes.array, PropTypes.func]),
...
class AclRouter extends Component {
    renderRedirectRoute = route => (
        <Route key={route.path} {...omitRouteRenderProperties(route)} render={() => <Redirect to={route.redirect} />} />
    )
